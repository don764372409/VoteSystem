    ...
    <form class="form form-horizontal">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="name" type="text" value="admin" placeholder="请输入姓名或电话" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="password" type="password" value="admin" placeholder="请输入密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
